...
# figure_4c.pl
#
# Volcano plot of tRNAs in control vs Dicer-knockdown
#
...
# Usage:
#   perl figure_4c.pl deseq_file cutoff
# Example
#   perl figure_4c.pl dat/dicer/serpent_annotation_extended.deseq > tmp/inputR.tab
