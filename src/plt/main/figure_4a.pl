...
# figure_4a.pl
#
# Volcano plot of miRNAs in control vs Dicer-knockdown
#
...
# Usage:
#   perl figure_4a.pl deseq_file cutoff
# Example
#   perl figure_4a.pl dat/dicer/serpent_annotation_extended.deseq > tmp/inputR.tab
