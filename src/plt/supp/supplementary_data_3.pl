...
#
# List of dfferentially processed profiles between cellular compartments
#
...
# Usage:
#   perl supplementary_data_2.pl annotation_file fold_change
# Example
#   perl supplementary_data_2.pl dat/serpent_annotation_extended.bed 2.5
