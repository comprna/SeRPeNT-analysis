# ############################################################################
# supplementary_figure_6.pl
#
# Volcano plots of control vs protein-knockdown
#
...
# Usage:
#   perl supplementary_figure_6.pl deseq_file cutoff
# Example
#   perl supplementary_figure_6.pl dat/dicer/serpent_annotation_extended.deseq > tmp/inputR.tab
