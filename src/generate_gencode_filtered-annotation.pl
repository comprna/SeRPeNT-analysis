# #################################################################################################
# generate_gencode_filtered-annotation.pl
#
# Filter Gencode annotation (GTF) files in order to extract miRNA, C/D-box snorna and tRNA
#
...
# Usage:
#   perl generate_gencode_filtered-annotation.pl gtf_file_1 ... gtf_file_n
# e.g.
#   perl generate_gencode_filtered-annotation.pl gencode.v19.annotation.gtf gencode.v19.tRNAs.gtf
